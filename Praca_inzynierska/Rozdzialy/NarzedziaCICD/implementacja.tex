...
% \includegraphics[scale=0.3]{StagesOverview.png} \\
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.58]{JobsOverview.png}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.8]{PipelineGuiApproach.png}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.8]{taskGroupMauiPrepare.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.8]{variableGroups.png}
