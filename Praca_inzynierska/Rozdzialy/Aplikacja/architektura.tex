...
zgodnie z ich przeznaczeniem oraz najważniejszą relacją z klasami sąsiadującymi.\todo{Opisać dokładniej połączenia między klasami?}
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.95\textwidth]{shortClassDiagram.png}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.4\textwidth]{projectDiagram.png}
